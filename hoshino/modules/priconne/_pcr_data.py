...
CHARA_NAME = {
    ...
    1076: ["可可萝(夏日)", "コッコロ(サマー)", "Kokkoro(Summer)", "水白", "水可", "水可可", "水可可萝", "水可可罗", "泳装可可萝", "泳装可可罗", "泳装妈"],
    1077: ["铃莓(夏日)", "スズメ(サマー)", "Suzume(Summer)", "水女仆", "水妹抖"],
    1078: ["凯留(夏日)", "キャル(サマー)", "Kyaru(Summer)", "水黑", "水黑猫", "水臭鼬", "泳装黑猫", "泳装臭鼬", "潶", "溴", "💧黑"],
    1079: ["珠希(夏日)", "タマキ(サマー)", "Tamaki(Summer)", "水猫剑", "水猫", "渵", "💧🐱🗡", "水🐱🗡"],
    ...
    1132: ["杏奈(夏日)", "アンナ(サマー)", "Anna(Summer)", "泳装中二", "泳装煤气罐", "水中二", "水煤气罐", "冲"],
    ...
    1802: ["优衣(公主)", "ユイ(プリンセス)", "Yui(Princess)", "公主种田", "公主田", "公主ue", "掉毛优衣", "掉毛ue", "掉毛", "飞翼优衣", "飞翼ue", "飞翼"],
    ...
    9500: ["会长", "会💊长", "group♂master", "cc", "初儿", "初宝", "梦境~缠绕", "缠缠"],
    9501: ["你自己", "別看了就你自己", "yourself", "憨批", "sb", "傻逼", "憨憨", "铁five", "five"]
}
